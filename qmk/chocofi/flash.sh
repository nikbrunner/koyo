...
UF2_FILE="crkbd_rev1_koyo_chocofi_rp2040_ce.uf2"
...
wait_for_rp2040() {
    ...
    warning_log "Put the Chocofi into bootloader mode (double-tap reset button)"
...
main() {
    ...
    if ! qmk compile -kb crkbd/rev1 -km koyo_chocofi -e CONVERT_TO=rp2040_ce; then
